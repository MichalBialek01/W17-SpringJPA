...
import org.example.infrastructure.database.entity.EntityMarker;
import org.example.infrastructure.database.repository.JPAMarkerClass;
...
@Configuration
@AllArgsConstructor
@EnableJpaRepositories(basePackageClasses = JPAMarkerClass.class)
